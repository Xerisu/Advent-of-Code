...
one_list_origami = [item for sublist in origami for item in sublist]
dots_on_origami = [item for item in one_list_origami if item > 0]
sum_dots = len(dots_on_origami)
